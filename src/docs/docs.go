...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/utils.CommonErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/validation.CreatePlanSuscripcion"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/model.PlanSuscripcion"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "422": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/utils.DetailedErrorResponse"
                        }
                    }
                }
            }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/validation.UpdatePlanSuscripcion"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "validation.CreatePlanSuscripcion": {
            "type": "object",
            "required": [
                "activo",
                "limite_descargas_mensuales",
        ...
        "validation.UpdatePlanSuscripcion": {
            "type": "object",
            "properties": {
                "activo": {
                    "type": "boolean"
